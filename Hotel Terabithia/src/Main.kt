...
fun main() {
    ...
    println("Bem vindo ao Hotel Cerejeiras")
    ...
    if(senha == senhaCorreta){
        println("Bem vindo ao Hotel Cerejeiras, $nomeUsuario. É um imenso prazer ter você por aqui!")
...
//--------------------------------------------------------------------------------------------------
fun reservaQuartos() {
    println("HOTEL CEREJEIRAS - RESERVA DE QUARTOS")
...
fun cadastroHospedes() {
    ...
    println("HOTEL CEREJEIRAS - CADASTRO DE HÓSPEDES")
...
fun pesquisarHospedes() {
    println("Bem-vindo à aba de pesquisas do Hotel Cerejeira!")
...
fun eventoHotel() {
    println("HOTEL CEREJEIRAS - EVENTOS")
...
//--------------------------------------------------------------------------------------------------
fun abastecerCarros() {
    println("HOTEL CEREJEIRAS - ABASTECER")
...
//--------------------------------------------------------------------------------------------------
fun manutencaoAr() {
    println("HOTEL CEREJEIRAS - MANUTENÇÃO DE AR-CONDICIONADOS")
